...
export default function Post() {
	const [ datasPost , setDatasPost ] = useState([]);
			...
			<ScrollView>
				<View style={styles.wrapper}>
					<View style={styles.container}>
						<Text style={styles.title}>Post n°{datasPost.id ? datasPost.id : ''}</Text>
						<Text style={styles.author}>{datasPost.id ? datasPost.title : ''} OU PROPS.FULLNAME</Text>
						<Text style={styles.content}>{datasPost.id ? datasPost.body : ''}</Text>
					</View>
